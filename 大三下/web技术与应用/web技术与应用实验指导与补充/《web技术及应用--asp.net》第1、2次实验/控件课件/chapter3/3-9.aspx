...
<body>
    ...
    <form runat="server">
        用户名：<asp:textbox id="user_name" runat="server"/><br>
	...
	<asp:RangeValidator id="Range1" ControlToValidate="age" MinimumValue="1" MaximumValue="150" ErrorMessage="年龄应该在1到150之间" Type="Integer" runat="server" />
